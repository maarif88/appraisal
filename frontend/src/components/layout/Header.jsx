      ...
      <div className="header-inner">
        ...
        <nav className="nav-links" aria-label="Main Navigation">
          ...
          >
            ...
            <div id="dropdown-solusi" className={`dropdown-drawer ${activeDropdown === 'solusi' ? 'is-open' : ''}`} onMouseEnter={() => setActiveDropdown('solusi')}>
                  ...
                  <div className="rotator-window">
                      ...
                      <div className="rotator-item-grid">
                        ...
                        <div className="rotator-item-right">
                          <div className="platform-vertical-list">
                            <div className="platform-list-item" title="Google Search">
                              <img className="platform-logo" src="https://ypym.app/logos/ypym-google-logo.svg" alt="Google Search" width="22" height="22" loading="lazy" decoding="async" />
                            </div>
                            <div className="platform-list-item" title="Bing Search">
                              <img className="platform-logo" src="https://ypym.app/logos/ypym-bing-logo.svg" alt="Bing Search" width="22" height="22" loading="lazy" decoding="async" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className={`rotator-item ${rotatorIndex === 1 ? 'active' : ((rotatorIndex - 1 + 5) % 5 === 1 ? 'exited' : '')}`}>
                      <div className="rotator-item-grid">
                        ...
                        <div className="rotator-item-right">
                          <div className="platform-vertical-list">
                            <div className="platform-list-item" title="Google Play">
                            ...
                            <div className="platform-list-item" title="App Store">
                            ...
                            <div className="platform-list-item" title="Google Mobile">
                              <img className="platform-logo" src="https://ypym.app/logos/ypym-google-logo.svg" alt="Google Mobile" width="22" height="22" loading="lazy" decoding="async" />
                            </div>
                            <div className="platform-list-item" title="Bing Mobile">
                              <img className="platform-logo" src="https://ypym.app/logos/ypym-bing-logo.svg" alt="Bing Mobile" width="22" height="22" loading="lazy" decoding="async" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className={`rotator-item ${rotatorIndex === 2 ? 'active' : ((rotatorIndex - 1 + 5) % 5 === 2 ? 'exited' : '')}`}>
                      <div className="rotator-item-grid">
                        ...
                        <div className="rotator-item-right">
                          <div className="platform-vertical-list">
                            <div className="platform-list-item" title="Google Search AI Overview">
                              <img className="platform-logo" src="https://ypym.app/logos/ypym-google-logo.svg" alt="Google Search AI Overview" width="22" height="22" loading="lazy" decoding="async" />
                            </div>
                            <div className="platform-list-item" title="Bing Copilot">
                              <img className="platform-logo" src="https://ypym.app/logos/ypym-microsoft-copilot-logo.svg" alt="Bing Copilot" width="22" height="22" loading="lazy" decoding="async" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className={`rotator-item ${rotatorIndex === 3 ? 'active' : ((rotatorIndex - 1 + 5) % 5 === 3 ? 'exited' : '')}`}>
                      <div className="rotator-item-grid">
                        ...
                        <div className="rotator-item-right">
                          <div className="platform-vertical-list">
                            <div className="platform-list-item" title="Perplexity AI">
                              <img className="platform-logo" src="https://ypym.app/logos/ypym-perplexity-ai-logo.svg" alt="Perplexity AI" loading="lazy" decoding="async" />
                            </div>
                            <div className="platform-list-item" title="OpenAI ChatGPT">
                              <img className="platform-logo" src="https://ypym.app/logos/ypym-chatgpt-logo.svg" alt="ChatGPT" loading="lazy" decoding="async" />
                            </div>
                            <div className="platform-list-item" title="Google Gemini">
                              <img className="platform-logo" src="https://ypym.app/logos/ypym-gemini-logo.svg" alt="Google Gemini" loading="lazy" decoding="async" />
                            </div>
                            <div className="platform-list-item" title="Anthropic Claude">
                              <img className="platform-logo" src="https://ypym.app/logos/ypym-claude-ai-logo.svg" alt="Claude AI" loading="lazy" decoding="async" />
                            </div>
                            <div className="platform-list-item" title="DeepSeek">
                              <img className="platform-logo" src="https://ypym.app/logos/ypym-deepseek-logo.svg" alt="DeepSeek" loading="lazy" decoding="async" />
                            </div>
                            <div className="platform-list-item" title="Grok AI">
                              <img className="platform-logo" src="https://ypym.app/logos/ypym-grok-ai-logo.svg" alt="Grok AI" loading="lazy" decoding="async" />
                            </div>
                            <div className="platform-list-item" title="Microsoft Bing Copilot">
                              <img className="platform-logo" src="https://ypym.app/logos/ypym-microsoft-copilot-logo.svg" alt="Microsoft Bing Copilot" loading="lazy" decoding="async" />
                            </div>
                            <div className="platform-list-item" title="Meta AI">
                              <img className="platform-logo" src="https://ypym.app/logos/ypym-meta-ai-logo.svg" alt="Meta AI" loading="lazy" decoding="async" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className={`rotator-item ${rotatorIndex === 4 ? 'active' : ((rotatorIndex - 1 + 5) % 5 === 4 ? 'exited' : '')}`}>
                      <div className="rotator-item-grid">
                        ...
                        <div className="rotator-item-right">
                          <div className="platform-vertical-list">
                            <div className="platform-list-item" title="Google Business Profile">
                              <img className="platform-logo" src="https://ypym.app/logos/ypym-google-logo.svg" alt="Google Maps" width="22" height="22" loading="lazy" decoding="async" />
                            </div>
                            <div className="platform-list-item" title="Bing Places">
                              <img className="platform-logo" src="https://ypym.app/logos/ypym-bing-logo.svg" alt="Bing Places" width="22" height="22" loading="lazy" decoding="async" />
                            </div>
                          </div>
                        </div>
                      </div>
